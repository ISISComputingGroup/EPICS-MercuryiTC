...
$(IFPRESSURE) dbLoadRecords("db/MercuryPressure.db", "P=$(MYPVPREFIX)$(IOCNAME):PRESSURE:$(PRESSURE_NUM):,PORT=L0,BOARD=$(PRESSURE_$(PRESSURE_NUM)),RECSIM=$(RECSIM),DISABLE=$(DISABLE)")
